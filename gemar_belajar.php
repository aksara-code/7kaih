    ...
    <div class="relative overflow-hidden bg-[#0b6a4d] pb-24 pt-10 rounded-b-[120px] shadow-[0_20px_40px_rgba(11,93,63,0.18)]">
        ...
        <div class="relative z-10 mx-auto max-w-4xl px-4 text-center">
            <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-[22px] bg-white shadow-lg shadow-emerald-900/10">
                <span class="text-[2.1rem]" aria-label="logo belajar">📚</span>
            </div>
            <h1 class="mt-7 text-[2.5rem] font-extrabold tracking-[-0.05em] text-white">Gemar Belajar</h1>
            ...
            <form class="space-y-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value="Matematika / IPA" class="w-full rounded-[14px] border border-slate-200 bg-[#edf3f2] py-3.5 pl-11 pr-4 text-base font-semibold text-slate-700 focus:border-[#0d6b4e] focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-100" />
                    </div>
                </div>

                <div>
                    <label class="mb-2 block text-[0.72rem] font-extrabold uppercase tracking-[0.14em] text-slate-700">Informasi yang didapat</label>
                    <textarea rows="4" class="w-full rounded-[14px] border border-slate-200 bg-[#edf3f2] px-4 py-3 text-base font-medium text-slate-700 placeholder:text-slate-500 focus:border-[#0d6b4e] focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-100" placeholder="Tuliskan hal yang kamu pelajari hari ini...">Hari ini saya belajar tentang pecahan dan cara menghitungnya dengan cepat.</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="rounded-[18px] border-2 border-dashed border-slate-200 bg-slate-50 p-4 text-center">
                        ...
                        <p class="mt-3 text-sm text-slate-500">Upload foto buku atau hasil belajar</p>
